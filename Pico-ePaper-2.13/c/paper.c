...
int main()
{
	...
	Paint_DrawString_EN(5, 10, "HELLO", &Font16, WHITE, BLACK);//顶格显示
    ...
    //Paint_DrawBitMap(gImage_2in13_2);//e-paper的图标
	//Paint_DrawBitMap(milkv);//milkv的图标
   // Paint_DrawPoint(250, 2, BLACK, DOT_PIXEL_2X2, DOT_STYLE_DFT);//黑点
